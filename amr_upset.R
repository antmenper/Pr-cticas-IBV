amr_upset <- function(binary_matrix, min_set_size = 2, order = "",plot_set_size = FALSE, plot_category = TRUE,      print_category_counts = FALSE, print_set_size = FALSE,                  boxplot_colour = "grey", assay = "mic") {
  ...
  assay_plot <- binary_matrix_wide %>%  # Formato ancho
    # con binary_matrix_wide cuenta cada columna como una variable (como tenemos guardados los datos).
...
save(amr_upset,file = "amr_upset.RData")
